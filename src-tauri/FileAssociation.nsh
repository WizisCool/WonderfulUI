...
; APP_ASSOCIATE_EX macro. Here you can specify the verb and what verb is to be
; the standard action (default verb).
;
...
; macro. Here is just another example just to wrap it up:
